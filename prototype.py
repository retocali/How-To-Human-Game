...
def setup(personCount, areaCount, objectcount):
    ...
    static_combos = {
        ...
        ("cry", "talk")    : "You have a hard time talking to your " +persons[personCount] +" and cry.",
        ...
        ("fight","sleep")  : "You get knocked out by " +persons[personCount],
        ("fight", "cry")   : "RIP. Lost a fight against " +persons[personCount],
        ("browse", "smile"): "Haha! You found some dank memes!",
        ("fight", "smile") : "You get into a playfight with your " +persons[personCount],
        ("fight", "talk")  : "Although a fight ensued with your " +persons[personCount] + "you managed to talk it out.",
        ...
        ("flirt", "talk")  : "Your casual conversation with your " +persons[personCount] + "turns into a steaming hot talk."+"\nIf you were a vegetable, you'd be a cute-cumber.",
